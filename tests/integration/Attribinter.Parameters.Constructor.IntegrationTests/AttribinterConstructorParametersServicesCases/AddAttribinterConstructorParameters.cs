...
public sealed class AddAttribinterConstructorParameters
{
    [Fact]
    ...
    private static IServiceCollection Target(IServiceCollection services) => AttribinterConstructorParametersServices.AddAttribinterConstructorParameters(services);
